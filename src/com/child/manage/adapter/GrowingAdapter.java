...
import com.child.manage.ui.GalleryUrlActivity;
import com.child.manage.ui.VideoViewActivity;
...
//                    roundImagePhoto.readBitmapViaVolley(favours.getCover(), imageView);
                    imageLoader.displayImage(favours.getCover(), imageView, ChildApplication.options, animateFirstListener);
