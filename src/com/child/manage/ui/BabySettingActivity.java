...
import com.child.manage.data.BabySetDATA;
import com.child.manage.data.BabySetNCDATA;
import com.child.manage.data.ErrorDATA;
import com.child.manage.data.UploadDATA;
import com.child.manage.entity.Account;
import com.child.manage.entity.BabySet;
...
import com.child.manage.util.CompressPhotoUtil;
                    ...
                    public void onResponse(String s) {
                        ...
                        try {
                            ...
                            if(data.getCode() == 200){
                                ...
                                try {
                                    imageLoader.displayImage(babySet.getCover() , tx, ChildApplication.options, animateFirstListener);
                                }catch (Exception e){
